...
На основании вышеизложенного мы выбираем цель  для сканирования - http://92.51.39.106:8050/ 
...
Приложение не сработало по цели:
...
**SQL Injections**
По адресу http://92.51.39.106:8050/users/login.php, в поле Username вводим admin' or '1'='1'#, а в поле Password любые символы, в данном случае 123:
![png](image-20.png)
![png](image-21.png)
...
**Local File Inclusion**
 Cоздадим файл exploit.html следующего содержания:
 ```
<html>
    <head>

        <tittle>plz sub test of hacking
        </title>
...
**SQL Injections**
 По CVSS v3 (БДУ ФСТЭК РФ) для SQL Injections базовая оценка (BS): 9.6:
![png](image-36.png)
...
**Cross Site Scripting**
 ...
 По CVSS v3 (БДУ ФСТЭК РФ) для Cross Site Scripting базовая оценка (BS): 8.8:
![png](image-37.png)
